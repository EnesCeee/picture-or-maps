...
public class ArtMainActivitySave extends AppCompatActivity {
    ...
    public void save(View view){
        ...
        Intent intent=new Intent(ArtMainActivitySave.this,ArtMainActivity.class);
